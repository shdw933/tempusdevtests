...
CJSCore::Init('jquery');
$APPLICATION->AddHeadScript("/bitrix/tools/maxyss.ozon/script.js");
...
if (Loader::includeModule('sale') && Loader::includeModule('iblock') && CModule::IncludeModule(MAXYSS_MODULE_NAME) && ($GLOBALS['APPLICATION']->GetGroupRight(MAXYSS_MODULE_NAME) >= "R")) {
...
//            "OPTIONS" => $arBackParametrs,
    ...
    <?
        ...
        ?>
        <form class="maxyss_wrap" action="<?= MAXYSS_MODULE_NAME ?>_order_ozon_maxyss.php?lang=<?= LANGUAGE_ID ?>" method="post">
            <?
            $tabControl->Begin();
            // табуляторы
            ?>
            ...
            foreach ($arTabs as $key_tab => $arTab) {
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="AWAITING_PACKAGING[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="AWAITING_DELIVER[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="NOT_ACCEPTED[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="ARBITRATION[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="DELIVERING[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="DRIVER_PICKUP[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="DELIVERED[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="CANCELLED[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="ACCEPTED_FROM_CUSTOMER[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="WAITING_FOR_SELLER[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="READY_FOR_SHIPMENT[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="RETURNED_TO_SELLER[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="CANCELLED_WITH_COMPENSATION[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
                ...
                <tr>
                    <td class="adm-detail-content-cell-r">
                        ...
                        <select name="DISPOSED[<?= $arTab["SITE_ID"] ?>]" data-status-select>
                            <option value=""><?= GetMessage('MAXYSS_OZON_SETTINGS_STATUS_SHIPMENT_NOT_USE_TEXT') ?></option>
                            <?
                            foreach ($arStatus as $key => $type) {
                                ?>
    ...
    <script type="text/javascript">
        ...
        function statusesSelectWatch(e){
            if(findParentsByAttr(e.target, 'data-count'))
